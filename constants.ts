...
const GJ_DATA = [
  { no: 1, name: "Abdasa" }, { no: 2, name: "Mandvi" }, { no: 3, name: "Bhuj" }, { no: 4, name: "Anjar" }, { no: 5, name: "Gandhidham (SC)" }, { no: 6, name: "Rapar" }, { no: 7, name: "Morbi" }, { no: 8, name: "Vav" }, { no: 9, name: "Tharad" }, { no: 10, name: "Dhanera" },
  { no: 11, name: "Danta (ST)" }, { no: 12, name: "Palanpur" }, { no: 13, name: "Deesa" }, { no: 14, name: "Deodar" }, { no: 15, name: "Vadgam (SC)" }, { no: 16, name: "Kankrej" }, { no: 17, name: "Radhanpur" }, { no: 18, name: "Chanasma" }, { no: 19, name: "Patan" }, { no: 20, name: "Sidhpur" },
  { no: 21, name: "Kheralu" }, { no: 22, name: "Unjha" }, { no: 23, name: "Visnagar" }, { no: 24, name: "Becharaji" }, { no: 25, name: "Kadi (SC)" }, { no: 26, name: "Mahesana" }, { no: 27, name: "Vijapur" }, { no: 28, name: "Mansa" }, { no: 29, name: "Himatnagar" }, { no: 30, name: "Idar (SC)" },
  { no: 31, name: "Khedbrahma (ST)" }, { no: 32, name: "Bhiloda (ST)" }, { no: 33, name: "Modasa" }, { no: 34, name: "Bayad" }, { no: 35, name: "Prantij" }, { no: 36, name: "Gandhinagar North" }, { no: 37, name: "Kalol" }, { no: 38, name: "Sanand" }, { no: 39, name: "Ghatlodia" }, { no: 40, name: "Vejalpur" },
  { no: 41, name: "Naranpura" }, { no: 42, name: "Sabarmati" }, { no: 43, name: "Dehgam" }, { no: 44, name: "Gandhinagar South" }, { no: 45, name: "Vatva" }, { no: 46, name: "Nikol" }, { no: 47, name: "Naroda" }, { no: 48, name: "Thakkarbapa Nagar" }, { no: 49, name: "Bapunagar" }, { no: 50, name: "Ellisbridge" },
  { no: 51, name: "Amraiwadi" }, { no: 52, name: "Dariapur" }, { no: 53, name: "Jamalpur - Khadia" }, { no: 54, name: "Maninagar" }, { no: 55, name: "Danilimda (SC)" }, { no: 56, name: "Asarwa (SC)" }, { no: 57, name: "Viramgam" }, { no: 58, name: "Dhandhuka" }, { no: 59, name: "Dasada (SC)" }, { no: 60, name: "Limbdi" },
  { no: 61, name: "Wadhwan" }, { no: 62, name: "Chotila" }, { no: 63, name: "Dhrangadhra" }, { no: 64, name: "Tankara" }, { no: 65, "name": "Wankaner" }, { no: 66, name: "Rajkot East" }, { no: 67, name: "Rajkot West" }, { no: 68, name: "Rajkot South" }, { no: 69, name: "Rajkot Rural (SC)" }, { no: 70, name: "Jasdan" },
  { no: 71, name: "Gondal" }, { no: 72, name: "Jetpur" }, { no: 73, name: "Dhoraji" }, { no: 74, name: "Porbandar" }, { no: 75, name: "Kutiyana" }, { no: 76, name: "Manavadar" }, { no: 92, name: "Dhari" }, { no: 93, name: "Amreli" }, { no: 94, name: "Lathi" }, { no: 95, name: "Savarkundla" },
  { no: 96, name: "Rajula" }, { no: 97, name: "Mahuva" }, { no: 98, name: "Gariadhar" }, { no: 99, name: "Talaja" }, { no: 100, name: "Palitana" }, { no: 101, name: "Bhavnagar Rural" }, { no: 102, name: "Bhavnagar East" }, { no: 103, name: "Bhavnagar West" }, { no: 104, name: "Gadhada (SC)" }, { no: 105, name: "Botad" },
  { no: 106, name: "Khambhat" }, { no: 107, name: "Borsad" }, { no: 108, name: "Anklav" }, { no: 109, name: "Umreth" }, { no: 110, name: "Anand" }, { no: 111, name: "Petlad" }, { no: 112, name: "Sojitra" }, { no: 113, name: "Daskroi" }, { no: 114, name: "Dholka" }, { no: 115, name: "Matar" },
  { no: 116, name: "Nadiad" }, { no: 117, name: "Mehmedabad" }, { no: 118, name: "Mahudha" }, { no: 119, name: "Kapadvanj" }, { no: 120, name: "Thasra" }, { no: 121, name: "Balasinor" }, { no: 122, name: "Lunawada" }, { no: 123, name: "Shahera" }, { no: 124, name: "Morva Hadaf (ST)" }, { no: 125, name: "Godhra" },
  { no: 126, name: "Kalol" }, { no: 127, name: "Santrampur (ST)" }, { no: 128, name: "Fatepura (ST)" }, { no: 129, name: "Jhalod (ST)" }, { no: 130, name: "Limkheda (ST)" }, { no: 131, name: "Dahod (ST)" }, { no: 132, name: "Garbada (ST)" }, { no: 133, name: "Devgadbaria" }, { no: 134, name: "Savli" }, { no: 135, name: "Vaghodia" },
  { no: 136, name: "Vadodara City (SC)" }, { no: 137, name: "Sayajigunj" }, { no: 138, name: "Akota" }, { no: 139, name: "Raopura" }, { no: 140, name: "Manjalpur" }, { no: 141, name: "Halol" }, { no: 142, name: "Chhota Udaipur (ST)" }, { no: 143, name: "Jetpur (ST)" }, { no: 144, name: "Sankheda (ST)" }, { no: 145, name: "Dabhoi" },
  { no: 146, name: "Padra" }, { no: 147, name: "Nandod (ST)" }, { no: 148, name: "Karjan" }, { no: 149, name: "Dediyapada (ST)" }, { no: 150, name: "Jambusar" }, { no: 151, name: "Vagra" }, { no: 152, name: "Jhagadia (ST)" }, { no: 153, name: "Bharuch" }, { no: 154, name: "Ankleshwar" }, { no: 155, name: "Mangrol (ST)" },
  { no: 156, name: "Mandvi (ST)" }, { no: 157, name: "Kamrej" }, { no: 158, name: "Bardoli (SC)" }, { no: 159, name: "Mahuva (ST)" }, { no: 160, name: "Vyara (ST)" }, { no: 161, name: "Nizar (ST)" }, { no: 162, name: "Olpad" }, { no: 163, name: "Surat East" }, { no: 164, name: "Surat North" }, { no: 165, "name": "Varachha Road" },
  { no: 166, name: "Karanj" }, { no: 167, name: "Katargam" },
];
